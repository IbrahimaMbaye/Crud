...
<body>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="file" name="image" class="form-control" id="input1">
        </div>
    </div>

    <div class="form-group">
        <label for="input1" class="col-sm-2 control-label">category</label>
        <div class="col-sm-10">
            <input type="text" name="category" placeholder="category" class="form-control" id="input1">
        </div>
    </div>

    <div class="form-group">
        <label for="input1" class="col-sm-2 control-label">stock</label>
        <div class="col-sm-10">
            <input type="text" name="stock" placeholder="stock" class="form-control" id="input1">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="name" placeholder="name" class="form-control" id="input1">
        </div>
    </div>
